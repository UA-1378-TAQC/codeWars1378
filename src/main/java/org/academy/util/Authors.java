...
public enum Authors {
    ...
    FYLYK_VIKTORIIA(1, "viktoriiafylyk", "Viktoriia Fylyk",
    ...
    MARTYNOVA_KHRYSTYNA(2, "KhrystynaTs", "Khrystyna Martynova",
    ...
    MYKHAILENKO_MARIIA(3, "MMykha", "Mariia Mykhailenko",
    ...
    ZUBENKO_DMYTRO(4, "dima123493", "Dmytro Zubenko",
    ...
    ORYNCHAK_ANATOLII(5, "Anat0li1", "Anatolii Orynchak",
    ...
    TARASIUK_NAZAR(6, "adidvar", "Nazar Tarasiuk",
    ...
    KMET_ROMAN(7, "RomanKmet", "Roman Kmet",
    ...
    HRUSHA_NATALIIA(8, "HrushaNataliia", "Nataliia Hrusha",
    ...
    SLOBODIANIUK_DMYTRO(9, "DMSlobodianiuk", "Dmytro Slobodianiuk",
    ...
    KOVALETS_BOHDAN(10, "BohdanKovalets", "Bohdan Kovalets",
    ...
    VEREMIIENKO_BOHDAN(11, "novitskiiy", "Bohdan Veremiienko",
    ...
    FEDKO_ROMAN(12, "roman50021", "Roman Fedko",
