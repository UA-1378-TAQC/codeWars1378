...
public class SevenDataProvider extends BaseDataProvider {
    ...
    protected Object[][] benefactorExceptionDataProvider() {
        Object[][] data = new Object[][]{
                ...
                {new double[]{14.25, 30.76, 5.56, 7.0, 9.0, 11.0, 15.48, 12.987}, 5.0},
                {new double[]{1400.25, 30000.76, 5.56, 7.0, 9.0, 11.0, 15.48, 120.98}, 2000.0},
                {new double[]{100.0}, 50.0},
                {new double[]{666.0, 747.0, 846.0, 558.0, 783.0, 162.0, 855.0, 180.0}, 533.0},
                {new double[]{86.0}, 43.0},
        };
        return combineDataProviders(data, SEVENS);
    }
